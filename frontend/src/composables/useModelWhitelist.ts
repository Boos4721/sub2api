...
const geminiPresetMappings = [
  ...
  { label: '3.1 Flash Lite', from: 'gemini-3.1-flash-lite', to: 'gemini-3.1-flash-lite', color: 'bg-green-100 text-green-700 hover:bg-green-200 dark:bg-green-900/30 dark:text-green-400' }
]
...
const antigravityPresetMappings = [
  ...
  { label: '3.1-Flash-Lite透传', from: 'gemini-3.1-flash-lite', to: 'gemini-3.1-flash-lite', color: 'bg-green-100 text-green-700 hover:bg-green-200 dark:bg-green-900/30 dark:text-green-400' },
  // Gemini 通配符映射
